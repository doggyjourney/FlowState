export class GroqDistractionDetector {
    config;
    constructor(config) {
        this.config = config;
    }
    async analyzeFocusEvent(event, task) {
    ...
    async analyzeResource(resource, task) {
        const cfg = await this.config.load();
        const apiKey = cfg.apiConfig.groq.apiKey;
        if (!apiKey) {
            return {
    ...
    buildAnalysisPrompt(event, task) {
...
Respond with a JSON object:
{
  ...
  "alternativeResources": [{"kind": "app|url", "id": "string", "title": "string"}] (optional)
    ...
    buildResourceAnalysisPrompt(resource, task) {
...
Respond with a JSON object:
{
  ...
  "suggestion": "close|warn|allow"
    ...
    async callGroqAPI(prompt, apiKey, config) {
